...
# Predefined questions and detailed answers about IoT
predefined_answers = {
    "What is IoT?": (
...
def get_chatbot_response(input_text):
    ...
    # Check if response data is a list and extract text accordingly
    if isinstance(response_data, list) and "generated_text" in response_data[0]:
        return response_data[0]["generated_text"]
    else:
        return "I'm not sure how to respond."

# Test the function with predefined questions
print(get_chatbot_response("What is IoT?"))
print(get_chatbot_response("How does IoT impact the healthcare industry?"))
